...
{
    public class IdentityServerProfileServiceTests
    {
        ...
        public IdentityServerProfileServiceTests()
        {
        ...
        private static ApplicationUser GetApplicationUser(string methodName)
        {
            return new ApplicationUser
            {
                ...
                FirstName = "John",
                LastName = "Doe",
                Email = typeof(IdentityServerProfileServiceTests).GenerateEmail(methodName),
                EmailConfirmed = true,
        ...
        private static ClaimsPrincipal GetSubject()
        {
        ...
        public async Task GetProfileDataAsync_ThrowsArgumentNullException_WhenSubjectIsNull()
        {
            ...
            var identityProfileService = new IdentityServerProfileService(_mockUserManager.Object, _mockUserClaimsPrincipalFactory.Object);
